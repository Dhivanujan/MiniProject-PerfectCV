...
def upload_cv():
    ...
    try:
        ...
        # Generate a PDF from the structured sections (creates template) and store that PDF in GridFS
        # pass sections so generate_pdf will render the ATS template
        pdf_bytes = generate_pdf(sections)
